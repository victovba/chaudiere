  ...
  <div class="container">
    <div class="cta-box">
      <div class="cta-box__content">
        <h2 class="cta-box__title">Besoin d'un devis pour votre chauffage ?</h2>
        <p class="cta-box__desc">
          Contactez-nous pour un devis gratuit et personnalisé. 
          Intervention dans tout le département des Vosges (88).
        </p>
        <div class="cta-box__features">
          <span class="cta-feature">✓ Devis sous 24h</span>
          <span class="cta-feature">✓ Sans engagement</span>
          <span class="cta-feature">✓ Aides calculées</span>
        </div>
      </div>
