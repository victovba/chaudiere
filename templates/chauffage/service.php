  ...
  <div class="container">
    <div class="cta-box">
      <div class="cta-box__content">
        ...
        <p>Contactez-nous pour une étude personnalisée de votre projet dans les Vosges.</p>
      </div>
      <div class="cta-box__actions">
        <a href="/contact?service=<?= urlencode($service['title']) ?>" class="btn btn--primary btn--large">📋 Demander un devis</a>
        <?php if ($phone): ?>
        <a href="tel:<?= e(preg_replace('/\s+/', '', $phone)) ?>" class="btn btn--outline btn--large">📞 <?= e($phone) ?></a>
        <?php endif; ?>
      </div>
    </div>
  </div>
