...
return [
  ...
  'heating_services' => [
    [
      ...
      'icon' => '🔥',
      'color' => '#6BAF92',
      'short_desc' => 'Installation & réparation gaz naturel/propane',
    ...
    [
      ...
      'icon' => '⚡',
      'color' => '#4F8A73',
      'short_desc' => 'Solution écologique sans conduit',
    ...
    [
      ...
      'icon' => '💧',
      'color' => '#A8D5C2',
      'short_desc' => 'Haute performance, rendement 109%',
    ...
    [
      ...
      'icon' => '🛢️',
      'color' => '#6B7280',
      'short_desc' => 'Remplacement & conversion gaz',
    ...
    [
      ...
      'icon' => '🌱',
      'color' => '#6BAF92',
      'short_desc' => 'PAC air/eau, économies 70%',
    ...
    [
      ...
      'icon' => '🌿',
      'color' => '#4F8A73',
      'short_desc' => 'Chauffage bois 100% écologique',
    ...
    [
      ...
      'icon' => '🏠',
      'color' => '#6BAF92',
      'short_desc' => 'Confort optimal invisible',
